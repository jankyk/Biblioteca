 ...
 * @author luis_
 */
public class RelatorioLivrosView extends javax.swing.JFrame {

    /**
     * Creates new form RelCidades
     */
    public RelatorioLivrosView() {
        initComponents();
    }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        // TODO add your handling code here:
        try{
            String wGenero = txtGenero.getText();
            
            Map<String, Object> parametros = new HashMap<String, Object>();
            parametros.put("Genero", wGenero);
            
            RelatoriosController objRelatorioCon = new RelatoriosController();            
            String wSQL = "SELECT l.idlivro, l.titulolivro, l.autorlivro, l.numpaginas, g.nomegenero "
                        + "FROM livros l, genero g "
                        + "WHERE l.idgenero = g.idgenero "
                        + "AND g.nomegenero = '"+ wGenero +"' ";
            ...
            JasperPrint jpPrint = JasperFillManager.fillReport("ireport/relatoriolivros.jasper", parametros, relResult);//Prepara o relatório para ser impresso, recebe o gerenciador JASPER
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioLivrosView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatorioLivrosView().setVisible(true);
            }
        });
    }
